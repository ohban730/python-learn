...
### 5. assert と raise の違いの検証
- **ファイル名**: [assert-and-raise.py](./assert-and-raise.py)
- **概要**: デバッグ用・前提条件チェックのための `assert` 文と、プロダクションコード・仕様上のエラー処理のための `raise` 文の挙動や用途の違いを確認するためのサンプルコードです。
