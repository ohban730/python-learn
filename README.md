...
### 『機械学習エンジニアのためのTransformers』由来のコードおよびドキュメント
*   **対象フォルダ**: [transformers-book/](./transformers-book/)
*   **著作者**: Lewis Tunstall, Leandro von Werra, Thomas Wolf / 中山 光樹（訳）
*   **出版社**: 株式会社オライリー・ジャパン (ISBN: 978-4-87311-995-3)
*   **権利関係**: 本フォルダ内のプログラムおよび解説ノートは、同書の公式サンプルコード (GitHub: [nlp-with-transformers](https://github.com/nlp-with-transformers/notebooks)) および書籍記述を元に作成・改変したものであり、オライリー社のサンプルコード利用規約および公正な使用の範囲に基づいています。
